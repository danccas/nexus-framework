...
class Pagination
{
  ...
  public function render()
  {
    ...
    $attrs .= ' data-in-Popup';
    $html = "<div class=\"intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-no-wrap items-center\">";
    $html .= "<ul class=\"pagination\" data-id=\"" . $this->id . "\">";
    if (!empty($this->previous)) {
      $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $link_anterior . "\" " . $attrs . ">Anterior</a></li>";
    } else {
      $html .= "<li class=\"page-item\"><a class=\"page-link disabled\">Anterior</a></li>";
    }
    ...
    foreach ($indices as $i) {
      ...
      if ($i == '...') {
        $html .= "<li class=\"page-item\"><a class=\"page-link\">&hellip;</span></li>";
      } elseif ($i == $this->page) {
        $html .= "<li class=\"page-item\"><a class=\"page-link page-link--active\" aria-label=\"Ir página " . $i . "\" href=\"" . $link_i . "\" " . $attrs . ">" . $i . "</a></li>";
      } else {
        $html .= "<li class=\"page-item\"><a class=\"page-link\" aria-label=\"Ir página " . $i . "\" href=\"" . $link_i . "\" " . $attrs . ">" . $i . "</a></li>";
      }
    }
    //$html .= "</ul>";
    if (!empty($this->next)) {
      $html .= "<li class=\"page-item\"><a class=\"page-link\" href=\"" . $link_siguiente . "\" " . $attrs . ">Siguiente</a></li>";
    } else {
      $html .= "<li class=\"page-item\"><a class=\"page-link disabled\" " . $attrs . ">Siguiente</li>";
    }
    $html .= "</ul>";
    $html .= "</div>";
    return $html;
